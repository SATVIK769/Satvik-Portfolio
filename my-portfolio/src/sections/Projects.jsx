...
import img1 from "../assets/AI Agent img 1.png"
import img2 from "../assets/Medi Flow img 1.png"
import img3 from "../assets/Ex Nota img 1.png"
import photo1 from "../assets/AI Agent img 2.png"
import photo2 from "../assets/Medi Flow img 2.png"
import photo3 from "../assets/Ex Nota img 2.png"
...
export default function Projects() {
  ...
  const projects = useMemo(
    () => [
      {
        title: "AI Agent",
        link: "https://ai-agent-69nx.onrender.com",
        bgColor: "#0d4d3d",
        image: isMobile ? photo1 : img1, // use mobile or desktop image
      },
      {
        title: "Hospital Management",
        link: "https://hospital-managementfrontend.onrender.com",
        bgColor: "#dc9317",
        image: isMobile ? photo2 : img2,
      },
      {
        title: "AI Notes Generator",
        link: "https://ai-notes-generatorclient.onrender.com",
        bgColor: "#3884d3",
                        ...
                        projects.map((project, idx) => (
                            <div key={project.title}
                                ...
                                style={{width:"85%", maxWidth: "1200px"}}>
                                  ...
                                  <div className={`relative w-full h-auto overflow-hidden bg-black/20 shadow-2xl md:shadow-[0_35px_-15px_rgba(0,0,0,0.7)] ${isMobile ? "mb-6 rounded-lg" : "mb-10 sm:mb-12 rounded-xl"} `} 
