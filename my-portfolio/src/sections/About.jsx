...
import p from "../assets/SAtvik Gupta Pic.jpeg"
...
export default function About() {
  ...
  const stats = [
    ...
    {label: "Speciality", value: ["MERN Stack", "AI Engineer"]},
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-center text-center md:text-left">
                ...
                <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl" >
                  I built scalable, modern applications with a strong focus on clean architecture, delightful UX, and performance. My toolkit spans React, Next.js, TypeScript, Tailwind CSS, and RESTfulAPI - bringing ideas to life from concept to production with robust APIs and smooth interfaces.
                </p>
                <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
                  {stats.map((item, i) => (
                    ...
                    >  
                      ...
                      <div className="text-base font-semibold tracking-wide whitespace-pre-line">
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
                  ...
                  <a href="#contact" className="inline-flex items-center justify-center rounded-lg text-white px-5 py-3 border border-white/20 bg-white/10 hover:bg-white/20 transition">Get In Touch</a>
                </div>
              </div>
          </motion.div>
