...
const socials = [
  // {icon: FaTwitter, label: "X", link: "https://x.com/satvikgupta"},
  {icon: FaLinkedinIn, label: "LinkedIn", link: "https://www.linkedin.com/in/satvik-gupta-10364b294"},
  {icon: FaGithub, label: "GitHub", link: "https://github.com/SATVIK769"}
]
...
export default function Home() {
  ...
  const roles = useMemo(() => ["Software Engineer", "Web Developer", "Tech Enthusiast"], []);
      ...
      <div className = "relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          <div className="w-full lg:pr-24 mx-auto max-w-3xl">
            ...
            <motion.h1
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-transparent bg-clip-text bg-linear-to-r from-[#1cd8c2] via-[#00bf8f] to-[#1cd8d2] drop-shadow-lg"
            ...
            >
              ...
              <a href="https://drive.google.com/file/d/1VkX3f32ijLXJcopY0ivZ70nHKOnnTQvJ/view?usp=sharing"
